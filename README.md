...
- The repository does not include MedleyDB audio or generated mixtures.
- Reported results depend on a selected MedleyDB subset and a limited number of splits.
- The polyphonic mixtures are controlled synthetic overlaps, not natural full-song mixes.
- The fixed 0.5 multi-label threshold contributes to over-prediction in the polyphonic setting.
- Full-backbone MERT fine-tuning was not explored because of computational constraints and dataset size.
